...
Visit the {BOARD NAME} product page here for more info: 
    https://adafruit.com/product/{PRODUCT ID}

To get started with CircuitPython, which comes built into your {BOARD NAME}, visit:
    https://learn.adafruit.com/welcome-to-circuitpython

#############################

The {BOARD NAME} has limited disk space so we have disabled Mac OS X indexing
...
The pre-loaded demo shows off what your {BOARD NAME} can do with CircuitPython:
  * {DEMO DETAILS}
